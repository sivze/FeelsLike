...
import me.sivze.feelslike.gcm.RegistrationIntentService;
import me.sivze.feelslike.sync.SunshineSyncAdapter;

public class ForecastActivity extends ActionBarActivity implements ForecastFragment.Callback{
    ...
    //when the user changes the location and come back it is detected in this method
    @Override
