...
public class WeatherProvider extends ContentProvider {
    ...
    //the following is a static constructor of the class
    static{
    ...
    /*
        s: We've coded this for you.  We just create a new WeatherDbHelper for later use
        here.
     */
    @Override
    ...
    /*
        s: Here's where you'll code the getType function that uses the UriMatcher.  You can
